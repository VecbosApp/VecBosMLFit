...
//=========  (Sat Dec  4 18:59:36 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-96.39075,3.180723,506.0514);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_222388928 = new TH1D("frame_222388928","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_222388928->SetMaximum(475.9293);
   frame_222388928->SetDirectory(0);
   frame_222388928->SetStats(0);
   frame_222388928->SetMarkerStyle(8);
   frame_222388928->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_222388928->GetXaxis()->SetLabelFont(132);
   frame_222388928->GetXaxis()->SetLabelSize(0.05);
   frame_222388928->GetXaxis()->SetTitleSize(0.06);
   frame_222388928->GetXaxis()->SetTitleFont(132);
   frame_222388928->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_222388928->GetYaxis()->SetLabelFont(132);
   frame_222388928->GetYaxis()->SetLabelSize(0.05);
   frame_222388928->GetYaxis()->SetTitleSize(0.06);
   frame_222388928->GetYaxis()->SetTitleFont(132);
   frame_222388928->GetZaxis()->SetLabelFont(132);
   frame_222388928->GetZaxis()->SetLabelSize(0.05);
   frame_222388928->GetZaxis()->SetTitleSize(0.06);
   frame_222388928->GetZaxis()->SetTitleFont(132);
   frame_222388928->Draw("");
   ...
   graph->SetPoint(1,-1,432.941);
   graph->SetPoint(2,0,432.941);
   graph->SetPoint(3,0.5,432.941);
   graph->SetPoint(4,0.75,432.941);
   graph->SetPoint(5,0.875,432.941);
   graph->SetPoint(6,0.9375,432.941);
   graph->SetPoint(7,0.96875,432.941);
   graph->SetPoint(8,0.984375,432.941);
   graph->SetPoint(9,0.9921875,432.941);
   graph->SetPoint(10,0.9960938,432.941);
   graph->SetPoint(11,1,14.30748);
   graph->SetPoint(12,1.5,14.30748);
   graph->SetPoint(13,1.75,14.30748);
   graph->SetPoint(14,1.875,14.30748);
   graph->SetPoint(15,1.9375,14.30748);
   graph->SetPoint(16,1.96875,14.30748);
   graph->SetPoint(17,1.984375,14.30748);
   graph->SetPoint(18,1.992188,14.30748);
   graph->SetPoint(19,1.996094,14.30748);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(476.2351);
   ...
   grae->SetPoint(0,0.5,431.976);
   grae->SetPointError(0,0.5,0.5,20.29004,21.29004);
   grae->SetPoint(1,1.5,14.3021);
   grae->SetPointError(1,0.5,0.5,3.736643,4.869158);
   grae->SetPoint(2,2.5,0);
   grae->SetPointError(2,0.5,0.5,0,1.147874);
   
   TH1 *h_OtherJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1 = new TH1F("h_OtherJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1","Histogram of OtherJets_plot__nBTagJets",100,0,3.3);
   h_OtherJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1->SetMinimum(0);
   h_OtherJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1->SetMaximum(498.5926);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(476.2351);
