...
//=========  (Sat Dec  4 11:33:22 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-0.9877795,3.180723,5.185843);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_372569520 = new TH1D("frame_372569520","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_372569520->SetMaximum(4.877162);
   frame_372569520->SetDirectory(0);
   frame_372569520->SetStats(0);
   frame_372569520->SetMarkerStyle(8);
   frame_372569520->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_372569520->GetXaxis()->SetLabelFont(132);
   frame_372569520->GetXaxis()->SetLabelSize(0.05);
   frame_372569520->GetXaxis()->SetTitleSize(0.06);
   frame_372569520->GetXaxis()->SetTitleFont(132);
   frame_372569520->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_372569520->GetYaxis()->SetLabelFont(132);
   frame_372569520->GetYaxis()->SetLabelSize(0.05);
   frame_372569520->GetYaxis()->SetTitleSize(0.06);
   frame_372569520->GetYaxis()->SetTitleFont(132);
   frame_372569520->GetZaxis()->SetLabelFont(132);
   frame_372569520->GetZaxis()->SetLabelSize(0.05);
   frame_372569520->GetZaxis()->SetTitleSize(0.06);
   frame_372569520->GetZaxis()->SetTitleFont(132);
   frame_372569520->Draw("");
   ...
   graph->SetPoint(1,-1,1.187532);
   graph->SetPoint(2,0,1.187532);
   graph->SetPoint(3,0.5,1.187532);
   graph->SetPoint(4,0.75,1.187532);
   graph->SetPoint(5,0.875,1.187532);
   graph->SetPoint(6,0.9375,1.187532);
   graph->SetPoint(7,0.96875,1.187532);
   graph->SetPoint(8,0.984375,1.187532);
   graph->SetPoint(9,0.9921875,1.187532);
   graph->SetPoint(10,0.9960938,1.187532);
   graph->SetPoint(11,1,2.177474);
   graph->SetPoint(12,1.5,2.177474);
   graph->SetPoint(13,1.75,2.177474);
   graph->SetPoint(14,1.875,2.177474);
   graph->SetPoint(15,1.9375,2.177474);
   graph->SetPoint(16,1.96875,2.177474);
   graph->SetPoint(17,1.984375,2.177474);
   graph->SetPoint(18,1.992188,2.177474);
   graph->SetPoint(19,1.996094,2.177474);
   graph->SetPoint(20,2,0.2509855);
   graph->SetPoint(21,3,0.2509855);
   graph->SetPoint(22,3,0.2509855);
   graph->SetPoint(23,4,0.2509855);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(2.395222);
   ...
   grae->SetPoint(0,0.5,1.081348);
   grae->SetPointError(0,0.5,0.5,0.8650381,2.327049);
   grae->SetPoint(1,1.5,2.005511);
   grae->SetPointError(1,0.5,0.5,1.293693,2.639405);
   grae->SetPoint(2,2.5,0.5295126);
   grae->SetPointError(2,0.5,0.5,0.4380373,1.757689);
   ...
   h_TopJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetMaximum(5.10026);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(2.395222);
