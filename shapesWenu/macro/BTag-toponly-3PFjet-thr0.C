...
//=========  (Sat Dec  4 10:36:54 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-1.025746,3.180723,5.385165);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_221230328 = new TH1D("frame_221230328","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_221230328->SetMaximum(5.064619);
   frame_221230328->SetDirectory(0);
   frame_221230328->SetStats(0);
   frame_221230328->SetMarkerStyle(8);
   frame_221230328->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_221230328->GetXaxis()->SetLabelFont(132);
   frame_221230328->GetXaxis()->SetLabelSize(0.05);
   frame_221230328->GetXaxis()->SetTitleSize(0.06);
   frame_221230328->GetXaxis()->SetTitleFont(132);
   frame_221230328->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_221230328->GetYaxis()->SetLabelFont(132);
   frame_221230328->GetYaxis()->SetLabelSize(0.05);
   frame_221230328->GetYaxis()->SetTitleSize(0.06);
   frame_221230328->GetYaxis()->SetTitleFont(132);
   frame_221230328->GetZaxis()->SetLabelFont(132);
   frame_221230328->GetZaxis()->SetLabelSize(0.05);
   frame_221230328->GetZaxis()->SetTitleSize(0.06);
   frame_221230328->GetZaxis()->SetTitleFont(132);
   frame_221230328->Draw("");
   ...
   graph->SetPoint(1,-1,1.43388);
   graph->SetPoint(2,0,1.43388);
   graph->SetPoint(3,0.5,1.43388);
   graph->SetPoint(4,0.75,1.43388);
   graph->SetPoint(5,0.875,1.43388);
   graph->SetPoint(6,0.9375,1.43388);
   graph->SetPoint(7,0.96875,1.43388);
   graph->SetPoint(8,0.984375,1.43388);
   graph->SetPoint(9,0.9921875,1.43388);
   graph->SetPoint(10,0.9960938,1.43388);
   graph->SetPoint(11,1,2.627782);
   graph->SetPoint(12,1.5,2.627782);
   graph->SetPoint(13,1.75,2.627782);
   graph->SetPoint(14,1.875,2.627782);
   graph->SetPoint(15,1.9375,2.627782);
   graph->SetPoint(16,1.96875,2.627782);
   graph->SetPoint(17,1.984375,2.627782);
   graph->SetPoint(18,1.992188,2.627782);
   graph->SetPoint(19,1.996094,2.627782);
   graph->SetPoint(20,2,0.2214068);
   graph->SetPoint(21,3,0.2214068);
   graph->SetPoint(22,3,0.2214068);
   graph->SetPoint(23,4,0.2214068);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(2.89056);
   ...
   grae->SetPoint(0,0.5,0.8128466);
   grae->SetPointError(0,0.5,0.5,0.6724243,2.083991);
   grae->SetPoint(1,1.5,2.144953);
   grae->SetPointError(1,0.5,0.5,1.341228,2.678494);
   grae->SetPoint(2,2.5,1.32533);
   grae->SetPointError(2,0.5,0.5,0.9783844,2.409597);
   ...
   h_TopJets_Cut[(nExclPFJetsHi > (3-0.5) )&& (nExclPFJetsHi < (3 + 0.5) )]1->SetMaximum(5.29175);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(2.89056);
