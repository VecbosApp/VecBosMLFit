...
//=========  (Sat Dec  4 15:34:35 2010) by ROOT version5.22/00d
   ...
   TH1 *frame_206557040 = new TH1D("frame_206557040","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_206557040->SetMaximum(1.205268);
   frame_206557040->SetDirectory(0);
   frame_206557040->SetStats(0);
   frame_206557040->SetMarkerStyle(8);
   frame_206557040->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_206557040->GetXaxis()->SetLabelFont(132);
   frame_206557040->GetXaxis()->SetLabelSize(0.05);
   frame_206557040->GetXaxis()->SetTitleSize(0.06);
   frame_206557040->GetXaxis()->SetTitleFont(132);
   frame_206557040->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_206557040->GetYaxis()->SetLabelFont(132);
   frame_206557040->GetYaxis()->SetLabelSize(0.05);
   frame_206557040->GetYaxis()->SetTitleSize(0.06);
   frame_206557040->GetYaxis()->SetTitleFont(132);
   frame_206557040->GetZaxis()->SetLabelFont(132);
   frame_206557040->GetZaxis()->SetLabelSize(0.05);
   frame_206557040->GetZaxis()->SetTitleSize(0.06);
   frame_206557040->GetZaxis()->SetTitleFont(132);
   frame_206557040->Draw("");
   ...
   graph->SetPoint(1,-1,0.959);
   graph->SetPoint(2,0,0.959);
   graph->SetPoint(3,0.5,0.959);
   graph->SetPoint(4,0.75,0.959);
   graph->SetPoint(5,0.875,0.959);
   graph->SetPoint(6,0.9375,0.959);
   graph->SetPoint(7,0.96875,0.959);
   graph->SetPoint(8,0.984375,0.959);
   graph->SetPoint(9,0.9921875,0.959);
   graph->SetPoint(10,0.9960938,0.959);
   graph->SetPoint(11,1,0.041);
   graph->SetPoint(12,1.5,0.041);
   graph->SetPoint(13,1.75,0.041);
   graph->SetPoint(14,1.875,0.041);
   graph->SetPoint(15,1.9375,0.041);
   graph->SetPoint(16,1.96875,0.041);
   graph->SetPoint(17,1.984375,0.041);
   graph->SetPoint(18,1.992188,0.041);
   graph->SetPoint(19,1.996094,0.041);
   graph->SetPoint(20,2,3.469447e-17);
   graph->SetPoint(21,3,3.469447e-17);
   graph->SetPoint(22,3,3.469447e-17);
   graph->SetPoint(23,4,3.469447e-17);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(1.0549);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(1.0549);
