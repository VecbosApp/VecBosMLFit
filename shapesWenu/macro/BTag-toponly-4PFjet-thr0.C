...
//=========  (Sat Dec  4 10:39:16 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-0.9115448,3.180723,4.785611);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_216226688 = new TH1D("frame_216226688","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_216226688->SetMaximum(4.500753);
   frame_216226688->SetDirectory(0);
   frame_216226688->SetStats(0);
   frame_216226688->SetMarkerStyle(8);
   frame_216226688->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_216226688->GetXaxis()->SetLabelFont(132);
   frame_216226688->GetXaxis()->SetLabelSize(0.05);
   frame_216226688->GetXaxis()->SetTitleSize(0.06);
   frame_216226688->GetXaxis()->SetTitleFont(132);
   frame_216226688->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_216226688->GetYaxis()->SetLabelFont(132);
   frame_216226688->GetYaxis()->SetLabelSize(0.05);
   frame_216226688->GetYaxis()->SetTitleSize(0.06);
   frame_216226688->GetYaxis()->SetTitleFont(132);
   frame_216226688->GetZaxis()->SetLabelFont(132);
   frame_216226688->GetZaxis()->SetLabelSize(0.05);
   frame_216226688->GetZaxis()->SetTitleSize(0.06);
   frame_216226688->GetZaxis()->SetTitleFont(132);
   frame_216226688->Draw("");
   ...
   graph->SetPoint(1,-1,1.264564);
   graph->SetPoint(2,0,1.264564);
   graph->SetPoint(3,0.5,1.264564);
   graph->SetPoint(4,0.75,1.264564);
   graph->SetPoint(5,0.875,1.264564);
   graph->SetPoint(6,0.9375,1.264564);
   graph->SetPoint(7,0.96875,1.264564);
   graph->SetPoint(8,0.984375,1.264564);
   graph->SetPoint(9,0.9921875,1.264564);
   graph->SetPoint(10,0.9960938,1.264564);
   graph->SetPoint(11,1,2.371702);
   graph->SetPoint(12,1.5,2.371702);
   graph->SetPoint(13,1.75,2.371702);
   graph->SetPoint(14,1.875,2.371702);
   graph->SetPoint(15,1.9375,2.371702);
   graph->SetPoint(16,1.96875,2.371702);
   graph->SetPoint(17,1.984375,2.371702);
   graph->SetPoint(18,1.992188,2.371702);
   graph->SetPoint(19,1.996094,2.371702);
   graph->SetPoint(20,2,0.3027101);
   graph->SetPoint(21,3,0.3027101);
   graph->SetPoint(22,3,0.3027101);
   graph->SetPoint(23,4,0.3027101);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(2.608873);
   ...
   grae->SetPoint(0,0.5,0.5309516);
   grae->SetPointError(0,0.5,0.5,0.4392277,1.759346);
   grae->SetPoint(1,1.5,1.737413);
   grae->SetPointError(1,0.5,0.5,1.169825,2.549018);
   grae->SetPoint(2,2.5,1.670951);
   grae->SetPointError(2,0.5,0.5,1.138949,2.526532);
   ...
   h_TopJets_Cut[(nExclPFJetsHi > (4-0.5) )&& (nExclPFJetsHi < (4 + 0.5) )]1->SetMaximum(4.705902);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(2.608873);
