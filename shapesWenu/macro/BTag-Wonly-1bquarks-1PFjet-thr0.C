...
//=========  (Sun Dec  5 13:05:04 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-7.360176,3.180723,38.64093);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_1378085368 = new TH1D("frame_1378085368","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_1378085368->SetMaximum(36.34087);
   frame_1378085368->SetDirectory(0);
   frame_1378085368->SetStats(0);
   frame_1378085368->SetMarkerStyle(8);
   frame_1378085368->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_1378085368->GetXaxis()->SetLabelFont(132);
   frame_1378085368->GetXaxis()->SetLabelSize(0.05);
   frame_1378085368->GetXaxis()->SetTitleSize(0.06);
   frame_1378085368->GetXaxis()->SetTitleFont(132);
   frame_1378085368->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_1378085368->GetYaxis()->SetLabelFont(132);
   frame_1378085368->GetYaxis()->SetLabelSize(0.05);
   frame_1378085368->GetYaxis()->SetTitleSize(0.06);
   frame_1378085368->GetYaxis()->SetTitleFont(132);
   frame_1378085368->GetZaxis()->SetLabelFont(132);
   frame_1378085368->GetZaxis()->SetLabelSize(0.05);
   frame_1378085368->GetZaxis()->SetTitleSize(0.06);
   frame_1378085368->GetZaxis()->SetTitleFont(132);
   frame_1378085368->Draw("");
   ...
   graph->SetPoint(1,-1,34.61035);
   graph->SetPoint(2,0,34.61035);
   graph->SetPoint(3,0.5,34.61035);
   graph->SetPoint(4,0.75,34.61035);
   graph->SetPoint(5,0.875,34.61035);
   graph->SetPoint(6,0.9375,34.61035);
   graph->SetPoint(7,0.96875,34.61035);
   graph->SetPoint(8,0.984375,34.61035);
   graph->SetPoint(9,0.9921875,34.61035);
   graph->SetPoint(10,0.9960938,34.61035);
   graph->SetPoint(11,1,1.479692);
   graph->SetPoint(12,1.5,1.479692);
   graph->SetPoint(13,1.75,1.479692);
   graph->SetPoint(14,1.875,1.479692);
   graph->SetPoint(15,1.9375,1.479692);
   graph->SetPoint(16,1.96875,1.479692);
   graph->SetPoint(17,1.984375,1.479692);
   graph->SetPoint(18,1.992188,1.479692);
   graph->SetPoint(19,1.996094,1.479692);
   graph->SetPoint(20,2,1.252125e-15);
   graph->SetPoint(21,3,1.252125e-15);
   graph->SetPoint(22,3,1.252125e-15);
   graph->SetPoint(23,4,1.252125e-15);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(38.07139);
   ...
   grae->SetPoint(0,0.5,18.31137);
   grae->SetPointError(0,0.5,0.5,4.23942,5.356562);
   grae->SetPoint(1,1.5,17.77867);
   grae->SetPointError(1,0.5,0.5,4.176171,5.295047);
   ...
   h_WJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1->SetMaximum(26.03472);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(38.07139);
   ...
   frame_1378085368->GetZaxis()->SetTitleSize(0.06);
   frame_1378085368->GetZaxis()->SetTitleFont(132);
   frame_1378085368->Draw("AXISSAME");
