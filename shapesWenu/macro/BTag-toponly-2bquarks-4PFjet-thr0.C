...
//=========  (Sat Dec  4 20:20:11 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-0.9355331,3.180723,4.911549);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_351613392 = new TH1D("frame_351613392","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_351613392->SetMaximum(4.619195);
   frame_351613392->SetDirectory(0);
   frame_351613392->SetStats(0);
   frame_351613392->SetMarkerStyle(8);
   frame_351613392->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_351613392->GetXaxis()->SetLabelFont(132);
   frame_351613392->GetXaxis()->SetLabelSize(0.05);
   frame_351613392->GetXaxis()->SetTitleSize(0.06);
   frame_351613392->GetXaxis()->SetTitleFont(132);
   frame_351613392->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_351613392->GetYaxis()->SetLabelFont(132);
   frame_351613392->GetYaxis()->SetLabelSize(0.05);
   frame_351613392->GetYaxis()->SetTitleSize(0.06);
   frame_351613392->GetYaxis()->SetTitleFont(132);
   frame_351613392->GetZaxis()->SetLabelFont(132);
   frame_351613392->GetZaxis()->SetLabelSize(0.05);
   frame_351613392->GetZaxis()->SetTitleSize(0.06);
   frame_351613392->GetZaxis()->SetTitleFont(132);
   frame_351613392->Draw("");
   ...
   graph->SetPoint(1,-1,1.182722);
   graph->SetPoint(2,0,1.182722);
   graph->SetPoint(3,0.5,1.182722);
   graph->SetPoint(4,0.75,1.182722);
   graph->SetPoint(5,0.875,1.182722);
   graph->SetPoint(6,0.9375,1.182722);
   graph->SetPoint(7,0.96875,1.182722);
   graph->SetPoint(8,0.984375,1.182722);
   graph->SetPoint(9,0.9921875,1.182722);
   graph->SetPoint(10,0.9960938,1.182722);
   graph->SetPoint(11,1,2.296177);
   graph->SetPoint(12,1.5,2.296177);
   graph->SetPoint(13,1.75,2.296177);
   graph->SetPoint(14,1.875,2.296177);
   graph->SetPoint(15,1.9375,2.296177);
   graph->SetPoint(16,1.96875,2.296177);
   graph->SetPoint(17,1.984375,2.296177);
   graph->SetPoint(18,1.992188,2.296177);
   graph->SetPoint(19,1.996094,2.296177);
   graph->SetPoint(20,2,0.4599664);
   graph->SetPoint(21,3,0.4599664);
   graph->SetPoint(22,3,0.4599664);
   graph->SetPoint(23,4,0.4599664);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(2.525795);
   ...
   grae->SetPoint(0,0.5,0.649276);
   grae->SetPointError(0,0.5,0.5,0.5371111,1.895615);
   grae->SetPoint(1,1.5,1.821699);
   grae->SetPointError(1,0.5,0.5,1.208981,2.577534);
   grae->SetPoint(2,2.5,1.468176);
   grae->SetPointError(2,0.5,0.5,1.044746,2.457926);
   ...
   h_TopJets_Cut[(nExclPFJetsHi > (4-0.5) )&& (nExclPFJetsHi < (4 + 0.5) )]1->SetMaximum(4.82794);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(2.525795);
