...
//=========  (Sun Dec  5 12:53:31 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-2247.685,3.180723,11800.35);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_458061016 = new TH1D("frame_458061016","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_458061016->SetMaximum(11097.94);
   frame_458061016->SetDirectory(0);
   frame_458061016->SetStats(0);
   frame_458061016->SetMarkerStyle(8);
   frame_458061016->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_458061016->GetXaxis()->SetLabelFont(132);
   frame_458061016->GetXaxis()->SetLabelSize(0.05);
   frame_458061016->GetXaxis()->SetTitleSize(0.06);
   frame_458061016->GetXaxis()->SetTitleFont(132);
   frame_458061016->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_458061016->GetYaxis()->SetLabelFont(132);
   frame_458061016->GetYaxis()->SetLabelSize(0.05);
   frame_458061016->GetYaxis()->SetTitleSize(0.06);
   frame_458061016->GetYaxis()->SetTitleFont(132);
   frame_458061016->GetZaxis()->SetLabelFont(132);
   frame_458061016->GetZaxis()->SetLabelSize(0.05);
   frame_458061016->GetZaxis()->SetTitleSize(0.06);
   frame_458061016->GetZaxis()->SetTitleFont(132);
   frame_458061016->Draw("");
   ...
   graph->SetPoint(1,-1,10224.04);
   graph->SetPoint(2,0,10224.04);
   graph->SetPoint(3,0.5,10224.04);
   graph->SetPoint(4,0.75,10224.04);
   graph->SetPoint(5,0.875,10224.04);
   graph->SetPoint(6,0.9375,10224.04);
   graph->SetPoint(7,0.96875,10224.04);
   graph->SetPoint(8,0.984375,10224.04);
   graph->SetPoint(9,0.9921875,10224.04);
   graph->SetPoint(10,0.9960938,10224.04);
   graph->SetPoint(11,1,437.107);
   graph->SetPoint(12,1.5,437.107);
   graph->SetPoint(13,1.75,437.107);
   graph->SetPoint(14,1.875,437.107);
   graph->SetPoint(15,1.9375,437.107);
   graph->SetPoint(16,1.96875,437.107);
   graph->SetPoint(17,1.984375,437.107);
   graph->SetPoint(18,1.992188,437.107);
   graph->SetPoint(19,1.996094,437.107);
   graph->SetPoint(20,2,3.698828e-13);
   graph->SetPoint(21,3,3.698828e-13);
   graph->SetPoint(22,3,3.698828e-13);
   graph->SetPoint(23,4,3.698828e-13);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(11246.44);
   ...
   grae->SetPoint(0,0.5,10466.66);
   grae->SetPointError(0,0.5,0.5,101.8079,102.8079);
   grae->SetPoint(1,1.5,178.2568);
   grae->SetPointError(1,0.5,0.5,12.86063,13.86063);
   ...
   h_WJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1->SetMaximum(11626.42);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(11246.44);
