...
//=========  (Sat Dec  4 09:53:36 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,0,596,572);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-63.68169,3.180723,334.3289);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_235504584 = new TH1D("frame_235504584","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_235504584->SetMaximum(314.4284);
   frame_235504584->SetDirectory(0);
   frame_235504584->SetStats(0);
   frame_235504584->SetMarkerStyle(8);
   frame_235504584->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_235504584->GetXaxis()->SetLabelFont(132);
   frame_235504584->GetXaxis()->SetLabelSize(0.05);
   frame_235504584->GetXaxis()->SetTitleSize(0.06);
   frame_235504584->GetXaxis()->SetTitleFont(132);
   frame_235504584->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_235504584->GetYaxis()->SetLabelFont(132);
   frame_235504584->GetYaxis()->SetLabelSize(0.05);
   frame_235504584->GetYaxis()->SetTitleSize(0.06);
   frame_235504584->GetYaxis()->SetTitleFont(132);
   frame_235504584->GetZaxis()->SetLabelFont(132);
   frame_235504584->GetZaxis()->SetLabelSize(0.05);
   frame_235504584->GetZaxis()->SetTitleSize(0.06);
   frame_235504584->GetZaxis()->SetTitleFont(132);
   frame_235504584->Draw("");
   ...
   graph->SetPoint(1,-1,293.1043);
   graph->SetPoint(2,0,293.1043);
   graph->SetPoint(3,0.5,293.1043);
   graph->SetPoint(4,0.75,293.1043);
   graph->SetPoint(5,0.875,293.1043);
   graph->SetPoint(6,0.9375,293.1043);
   graph->SetPoint(7,0.96875,293.1043);
   graph->SetPoint(8,0.984375,293.1043);
   graph->SetPoint(9,0.9921875,293.1043);
   graph->SetPoint(10,0.9960938,293.1043);
   graph->SetPoint(11,1,12.53105);
   graph->SetPoint(12,1.5,12.53105);
   graph->SetPoint(13,1.75,12.53105);
   graph->SetPoint(14,1.875,12.53105);
   graph->SetPoint(15,1.9375,12.53105);
   graph->SetPoint(16,1.96875,12.53105);
   graph->SetPoint(17,1.984375,12.53105);
   graph->SetPoint(18,1.992188,12.53105);
   graph->SetPoint(19,1.996094,12.53105);
   graph->SetPoint(20,2,1.060386e-14);
   graph->SetPoint(21,3,1.060386e-14);
   graph->SetPoint(22,3,1.060386e-14);
   graph->SetPoint(23,4,1.060386e-14);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(322.4147);
   ...
   grae->SetPoint(0,0.5,298.7018);
   grae->SetPointError(0,0.5,0.5,0.7538264,0.7538264);
   grae->SetPoint(1,1.5,6.944299);
   grae->SetPointError(1,0.5,0.5,0.1149388,0.1149388);
   grae->SetPoint(2,2.5,0);
   grae->SetPointError(2,0.5,0.5,0,0);
   ...
   h_WJets_Cut[(nExclPFJetsHi > (1-0.5) )&& (nExclPFJetsHi < (1 + 0.5) )]1->SetMaximum(329.4011);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(322.4147);
