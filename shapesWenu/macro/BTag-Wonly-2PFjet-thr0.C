...
//=========  (Sat Dec  4 09:59:04 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-8.015681,3.180723,42.08233);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_1286724376 = new TH1D("frame_1286724376","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_1286724376->SetMaximum(39.57743);
   frame_1286724376->SetDirectory(0);
   frame_1286724376->SetStats(0);
   frame_1286724376->SetMarkerStyle(8);
   frame_1286724376->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_1286724376->GetXaxis()->SetLabelFont(132);
   frame_1286724376->GetXaxis()->SetLabelSize(0.05);
   frame_1286724376->GetXaxis()->SetTitleSize(0.06);
   frame_1286724376->GetXaxis()->SetTitleFont(132);
   frame_1286724376->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_1286724376->GetYaxis()->SetLabelFont(132);
   frame_1286724376->GetYaxis()->SetLabelSize(0.05);
   frame_1286724376->GetYaxis()->SetTitleSize(0.06);
   frame_1286724376->GetYaxis()->SetTitleFont(132);
   frame_1286724376->GetZaxis()->SetLabelFont(132);
   frame_1286724376->GetZaxis()->SetLabelSize(0.05);
   frame_1286724376->GetZaxis()->SetTitleSize(0.06);
   frame_1286724376->GetZaxis()->SetTitleFont(132);
   frame_1286724376->Draw("");
   ...
   graph->SetPoint(1,-1,36.34249);
   graph->SetPoint(2,0,36.34249);
   graph->SetPoint(3,0.5,36.34249);
   graph->SetPoint(4,0.75,36.34249);
   graph->SetPoint(5,0.875,36.34249);
   graph->SetPoint(6,0.9375,36.34249);
   graph->SetPoint(7,0.96875,36.34249);
   graph->SetPoint(8,0.984375,36.34249);
   graph->SetPoint(9,0.9921875,36.34249);
   graph->SetPoint(10,0.9960938,36.34249);
   graph->SetPoint(11,1,3.107492);
   graph->SetPoint(12,1.5,3.107492);
   graph->SetPoint(13,1.75,3.107492);
   graph->SetPoint(14,1.875,3.107492);
   graph->SetPoint(15,1.9375,3.107492);
   graph->SetPoint(16,1.96875,3.107492);
   graph->SetPoint(17,1.984375,3.107492);
   graph->SetPoint(18,1.992188,3.107492);
   graph->SetPoint(19,1.996094,3.107492);
   graph->SetPoint(20,2,0.06642709);
   graph->SetPoint(21,3,0.06642709);
   graph->SetPoint(22,3,0.06642709);
   graph->SetPoint(23,4,0.06642709);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(39.97674);
   ...
   grae->SetPoint(0,0.5,37.42594);
   grae->SetPointError(0,0.5,0.5,0.2668495,0.2668495);
   grae->SetPoint(1,1.5,2.043252);
   grae->SetPointError(1,0.5,0.5,0.06234796,0.06234796);
   grae->SetPoint(2,2.5,0.04375704);
   grae->SetPointError(2,0.5,0.5,0.009123974,0.009123974);
   
   TH1 *h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1 = new TH1F("h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1","Histogram of WJets_plot__nBTagJets",100,0,3.3);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetMinimum(0);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetMaximum(41.4586);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetDirectory(0);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetStats(0);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetMarkerStyle(8);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetXaxis()->SetLabelFont(132);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetXaxis()->SetLabelSize(0.05);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetXaxis()->SetTitleSize(0.06);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetXaxis()->SetTitleFont(132);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetYaxis()->SetLabelFont(132);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetYaxis()->SetLabelSize(0.05);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetYaxis()->SetTitleSize(0.06);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetYaxis()->SetTitleFont(132);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetZaxis()->SetLabelFont(132);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetZaxis()->SetLabelSize(0.05);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetZaxis()->SetTitleSize(0.06);
   h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->GetZaxis()->SetTitleFont(132);
   grae->SetHistogram(h_WJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(39.97674);
   ...
   frame_1286724376->GetZaxis()->SetTitleSize(0.06);
   frame_1286724376->GetZaxis()->SetTitleFont(132);
   frame_1286724376->Draw("AXISSAME");
