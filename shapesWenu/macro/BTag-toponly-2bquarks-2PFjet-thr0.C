...
//=========  (Sun Dec  5 13:38:04 2010) by ROOT version5.22/00d
   TCanvas *c = new TCanvas("c", "fitResult",0,22,600,600);
   gStyle->SetOptStat(0);
   c->Range(-0.4337349,-4.854067,3.180723,25.48385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1 *frame_357507288 = new TH1D("frame_357507288","A RooPlot of "n_{b-tag jets}"",3,0,3);
   frame_357507288->SetMaximum(23.96696);
   frame_357507288->SetDirectory(0);
   frame_357507288->SetStats(0);
   frame_357507288->SetMarkerStyle(8);
   frame_357507288->GetXaxis()->SetTitle("N_{b-tag jets}");
   frame_357507288->GetXaxis()->SetLabelFont(132);
   frame_357507288->GetXaxis()->SetLabelSize(0.05);
   frame_357507288->GetXaxis()->SetTitleSize(0.06);
   frame_357507288->GetXaxis()->SetTitleFont(132);
   frame_357507288->GetYaxis()->SetTitle("Events / (1.00 )");
   frame_357507288->GetYaxis()->SetLabelFont(132);
   frame_357507288->GetYaxis()->SetLabelSize(0.05);
   frame_357507288->GetYaxis()->SetTitleSize(0.06);
   frame_357507288->GetYaxis()->SetTitleFont(132);
   frame_357507288->GetZaxis()->SetLabelFont(132);
   frame_357507288->GetZaxis()->SetLabelSize(0.05);
   frame_357507288->GetZaxis()->SetTitleSize(0.06);
   frame_357507288->GetZaxis()->SetTitleFont(132);
   frame_357507288->Draw("");
   ...
   graph->SetPoint(1,-1,7.138606);
   graph->SetPoint(2,0,7.138606);
   graph->SetPoint(3,0.5,7.138606);
   graph->SetPoint(4,0.75,7.138606);
   graph->SetPoint(5,0.875,7.138606);
   graph->SetPoint(6,0.9375,7.138606);
   graph->SetPoint(7,0.96875,7.138606);
   graph->SetPoint(8,0.984375,7.138606);
   graph->SetPoint(9,0.9921875,7.138606);
   graph->SetPoint(10,0.9960938,7.138606);
   graph->SetPoint(11,1,21.71576);
   graph->SetPoint(12,1.5,21.71576);
   graph->SetPoint(13,1.75,21.71576);
   graph->SetPoint(14,1.875,21.71576);
   graph->SetPoint(15,1.9375,21.71576);
   graph->SetPoint(16,1.96875,21.71576);
   graph->SetPoint(17,1.984375,21.71576);
   graph->SetPoint(18,1.992188,21.71576);
   graph->SetPoint(19,1.996094,21.71576);
   graph->SetPoint(20,2,8.638313);
   graph->SetPoint(21,3,8.638313);
   graph->SetPoint(22,3,8.638313);
   graph->SetPoint(23,4,8.638313);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]1->SetMaximum(23.88734);
   ...
   grae->SetPoint(0,0.5,5.418516);
   grae->SetPointError(0,0.5,0.5,2.251865,3.466665);
   grae->SetPoint(1,1.5,17.55667);
   grae->SetPointError(1,0.5,0.5,4.149375,5.26901);
   grae->SetPoint(2,2.5,14.52551);
   grae->SetPointError(2,0.5,0.5,3.76633,4.897834);
   ...
   h_TopJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetMinimum(1.200749);
   h_TopJets_Cut[(nExclPFJetsHi > (2-0.5) )&& (nExclPFJetsHi < (2 + 0.5) )]1->SetMaximum(24.79158);
   ...
   myFit_Norm[nBTagJets,nExclPFJetsHi]_Slice[nExclPFJetsHi]2->SetMaximum(23.88734);
